...
Clarified the use of scopes in JWT        | [Authentication](fs_authentication.html){:target="\_blank"}																	| Revised the text around the use of scopes to correlate with the updated table data    | <mark style="background-color: LightGreen">non-breaking</mark>
