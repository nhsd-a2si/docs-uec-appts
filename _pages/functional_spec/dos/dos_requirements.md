...
* The appointment consumer (111 system in the example above):
  ...
  * MUST ensure that if no booking endpoint is returned by the GetCapacitySummary or GetServiceDetailsByID API call that any other proprietary booking mechanisms still work and are then subsequently tried
* The DoS:
