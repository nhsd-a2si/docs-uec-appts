...
Each of the three locations has its own appointment diary represented as a schedule in ANGPS. Location 3 has two diaries, a GP diary like the other two and a Nurse diary also (see figure 2):
...
The table below shows key information about the associated DoS services and the HealthcareServicesID defined against each service:
...
The following digram shows the relationship of DoS services to appointment schedules.
