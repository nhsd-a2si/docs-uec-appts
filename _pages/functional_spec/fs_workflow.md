...
The booking is made following a similar process as getting available slots. However this time a post is made to the SSP with a serialised <a href="{{sidebar[0].speclink}}" target="_blank">FHIR appointment resource</a> as the payload.
